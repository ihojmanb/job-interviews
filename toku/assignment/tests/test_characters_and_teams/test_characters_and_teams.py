...
# Tests to verify that team and character communicate correctly
    ...
    def test_set_character_attacks(self):
    ...
    def test_mental_attack_computed_correcty(self):
        character =random.choice(team.members)
        mental_attack_value = (
    ...
    def test_strong_attack_computed_correcty(self):
        character =random.choice(team.members)
        strong_attack_value = (
    ...
    def test_fast_attack_computed_correcty(self):
        character =random.choice(team.members)
        fast_attack_value = (
